...
const Home = () => {
    ...
    return (
        <>
            ...
            <div className='flex flex-col h-screen items-left md:items-center pt-10 pb-3  md:py-20 bg-[#F6F4ED] md:bg-[url("/mediumm.webp")] bg-size-[auto_600px] bg-no-repeat md:bg-right border-b-1'>
                ...
                <div className="w-9/12 ps-6 md:ps-0 pt-12 text-left text-xl ">
                    <button onClick={()=>setIsModalSignupOpen(true)} className=" bg-green-700 md:bg-black px-5 w-10/12 md:w-[200px]  py-3 rounded-4xl text-white cursor-pointer font-light">Start reading</button>
                </div>
            </div>
        </>
    )
