const Card = () => {
    return (
        <>
            <div className="flex flex-col  gap-5 mt-20  items-start justify-center  h-1/4 w-9/12 pb-20 border-b border-gray-200 ">
                ...
                <div className="flex justify-between gap-15">
                    <div className="flex flex-col items-start gap-2 ">
                        <h2 className="text-2xl font-bold tracking-tight text-start pe-10">Keep up to date with Medium writers you love even more easily</h2>
                        <p className="text-md/9 tracking-wide text-start text-neutral-500 font-light">Product update: Follow writers and get email notifications for new stories — in one click</p>
                    </div>
                    <div className="w-65 h-27">
                        <img src="../public/assets/right-3.png" className="w-full h-full" alt="" />
                    </div>
                </div>
                <div className="flex justify-between items-center w-8/12 text-gray-500 ">
